...
const projectSection = [
  {
    id: 0,
    img: './images/capstone1-desktop.png',
    title: 'SOP Global Summit',
    mobileImg: './images/capstone1-mobile.png',
    desktopImg: './images/capstone1-desktop.png',
    supportingText: 'The capstone is a simple webpage which portrays an imaginary summit event, SOP Global Summit. It consists of a home page and an about page. It was built with CSS and JavaScript. ',
    langBox: {
      css: 'CSS', html: 'HTML', Bootstrap: 'JavaScript', Ruby: 'Linters',
    },
    button: 'See Project',
    seeLive: 'https://krisbobo.github.io/capstone-summit/',
    seeSource: 'https://github.com/krisbobo/capstone-summit',
  },
  {
    id: 1,
    img: './images/awesomebooks-desktop.png',
    title: 'Awesome Books',
    mobileImg: './images/awesomebooks-mobile.png',
    desktopImg: './images/awesomebooks-desktop.png',
    supportingText: 'Awesome books is a simple website that displays a list of books and allows you to add and remove books from that list. In building this application, I built the core functionalities using JavaScript. ',
    langBox: {
      css: 'CSS', html: 'HTML', Bootstrap: 'JavaScript', Ruby: 'ES6-modules',
    },
    button: 'See Project',
    seeLive: 'https://krisbobo.github.io/awesomebook-restructure/',
    seeSource: 'https://github.com/krisbobo/awesomebook-restructure',
  },
  {
    id: 2,
